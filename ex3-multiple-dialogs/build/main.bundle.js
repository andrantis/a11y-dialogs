...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(86), __webpack_require__(295)(module)))
...
function pageLoaded(event) {
    Array.from(document.querySelectorAll(".js-dialog-trigger")).forEach(function (item) {
...
function openDialog() {
    ...
    var target = previousActiveElement.dataset.dialogTarget;
    var dialogSelector = ".dialog[data-dialog='" + target + "']";
    ...
    Array.from(dialogWindow.querySelectorAll('button')).forEach(function (btn) {
